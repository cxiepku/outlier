...
The test data mentioned above is in the folder "data/", which is the GTEx brain data (see the manuscript for further information). The full data is in the supplemental materials of the manuscript or ENA (see the manuscript).
